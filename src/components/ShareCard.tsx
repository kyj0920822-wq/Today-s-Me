      ...
      <div className="flex-1 flex items-center justify-center w-full max-h-[80vh]">
        ...
        >
          ...
          <div className="relative z-10 mt-4 w-full text-center">
            <h3 className="text-4xl font-gaegu font-bold tracking-tight leading-tight px-2" style={{ color: config.secondaryColor }}>
              {getStateKoreanName(status)}
            </h3>
          </div>

          <div className="relative z-10 mt-auto mb-64 flex flex-col items-center gap-1.5 px-6">
